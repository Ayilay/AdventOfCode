...
def SolverThread( origNodes, candidates, results ):
    ...
    while not candidates.empty():
        ...
        ntrails = solveMaze( nodes, cand )
        totntrails += ntrails
        print( f"Start {cand}: found {ntrails} trails")

    print( f"found {totntrails} total trails")

    results.put( totntrails )
...
def SOLVER_PrintSolution():
    ...
    print( f"Num trailheads: {totntrails}" )
